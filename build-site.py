...
PAGES = {
    ...
    'aure-swarm': {
        ...
        'content': {
            ...
            'description': "Inside AURE: a 16-agent autonomous GEO system built to publish, optimize, and propagate entity signals across AI search platforms at scale.",
            ...
            'subtitle': "A 16-agent autonomous system designed to publish entity signals at machine scale.",
