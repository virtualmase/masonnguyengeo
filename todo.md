...
- [x] Migrate the shared research-page palette from void/parchment/gold to the original ultramarine-and-ivory token system on `manus/ultramarine-ivory-theme`.
- [x] Validate the new shared research-page foundation on `/what-is-geo/` at desktop and mobile widths without altering its content.
